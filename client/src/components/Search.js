...
const Search = ({ currentUser, courseData, setCourseData, myFavorite, setMyFavorite, allCourses, setAllCourses }) => {
                                    ...
                                    <div className="card border-0 mb-4">                                    
                                        ...
                                        <div className="card-footer">
                                            { courseData.length > 0 && courseData.filter((j) => j._id === i._id).length > 0 && (
                                                <Link className="btn bg-light-primary hover-bg-primary" id={ i._id }>
                                                    上課去
                                                </Link>                                        
                                            )}
                                            { courseData.length === 0 || courseData.filter((j) => j._id === i._id).length === 0 && (
                                                <button onClick={ handleEnroll } className="btn bg-light-primary hover-bg-primary handle-enroll-1" id={ i._id }>
                                                    註冊
                                                </button>                                        
                                            )}
                                        </div>
                            ...
                            { allCourses && allCourses.map((i) => (
                                <div className="col-md-6 col-lg-4 card-group">
                                    <div className="card border-0 mb-4">                                    
                                        ...
                                        <div className="card-footer">
                                            { courseData.length > 0 && courseData.filter((j) => j._id === i._id).length > 0 && (
                                                <a href="#" onClick={ handleEnroll } className="btn hover-bg-warning" id={ i._id }>
                                                上課去
                                            </a>                                        
                                            )}
                                            { courseData.length > 0 && courseData.filter((j) => j._id === i._id).length === 0 && (
